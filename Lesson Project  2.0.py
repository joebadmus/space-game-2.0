...
MOVE = [pygame.image.load(os.path.join('Assets', 'spaceship_red.png')), pygame.image.load(os.path.join('Assets', 'spaceship_red2.png')), pygame.image.load(os.path.join('Assets', 'spaceship_red3.png'))]

SPACESHIP_PARAMETER1, SPACESHIP_PARAMETER2 = 50, 70
...
def main():
    ...
    red=pygame.Rect(WIDTH - 100, 350, SPACESHIP_PARAMETER1, SPACESHIP_PARAMETER2)
